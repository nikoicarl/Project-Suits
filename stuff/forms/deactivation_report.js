function Report() {
    ...
    function DeactivationReportForm() {
        return `
            <div class="card">
                <div class="card-body">
                    <form action="" class="ps_deactivation_report_form">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <select class="form-control select_search ps_deactivation_report_user"></select>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    <label>Pick Date in Range </label>
                                    <div class="form-control ps_deactivation_report_date_range">
                                        <i class="icon-calendar2"></i>&nbsp;
                                        <span></span> <i class="icon-caret-down"></i>
                                        <input class="ps_deactivation_report_date" type="hidden">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary ps_deactivation_report_submit float-right"><i class="icon-stats-dots mr-2"></i> Run Report</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 mt-4 ps_deactivation_report_display_page"></div>
            </div>
        
        `;
    }

    function DeactivationReportPage(data) {
        ...
        <table class="table table-striped" width="100%">
            <thead>
                <tr class="bg-primary">
                    ...
                    <th style="font-size:12px;" class="text-white">Deactivated By</th>
        ...
        return `
            <div class="card">
                <div class="card-body mb-3" id="ps_report_print_div">
                    <div class="row ">
                        <div class="col-sm-12 col-md-6"><h4 style="font-size: 32px; font-weight: 700; color: #0e1726;">DEACTIVATION REPORT</h4></div>
    ...
    function DeactivationReportPageUser(data) {
        let logo = `<img src="assets/img/logo.png" style="max-width: 100%; height: auto;"/>`
