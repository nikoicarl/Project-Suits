function Report() {
    ...
    <div class="layout-px-spacing mb-5">
        <div class="row layout-top-spacing">
            <div class="col-md-12" id="ps_recent_activity_page_form_display"></div>
        </div>
    </div>
    `;
    }
    ...
    return `
        <div class="card">
            <div class="card-body">
                <form action="" class="ps_recent_activity_form">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                <label>Name <span class="text-danger">*</span></label>
                                <select class="form-control select_search ps_recent_activity_user"></select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control float-right" id="ps_recent_activity_date_range">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-primary ps_recent_activity_submit float-right">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title" >Recent Activity Report</h3>
    ...
    html = ejs.render(RecentActivityForm(), {});
    $('#ps_recent_activity_page_form_display').html(html);
