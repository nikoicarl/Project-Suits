...
function Sidebar() {
    return `
        ...
        <aside class="main-sidebar ps_sidebar_bg elevation-4">
            <!-- Brand Logo -->
            <a href="/dashboard" class="brand-link text-center ps_main_navigation_btn" data-appname="pearson_specter" data-navparent="dashboard" data-scripts="single::/dashboardAjax">
            ...
            <div class="sidebar">
                <!-- Sidebar Menu -->
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false" id="navbar_overall_parent">
                        <li class="nav-item">
