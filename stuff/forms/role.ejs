                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control ps_manage_client_name" placeholder="Role Name" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-2 mb-4">
                            <div class="col-md-12">
                                <div class="d-inline-flex w-100">
                                    ...
                                    <input type="text" class="ml-3 form-control form-control-sm" id="ps_role_general_search" placeholder="Search table...">
                                </div>
                            </div>
                        </div>
